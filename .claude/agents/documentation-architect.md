...
description: Use this agent when you need to create, update, or enhance documentation for any part of the codebase. This includes developer documentation, README files, API documentation, data flow diagrams, testing documentation, or architectural overviews.
allowed-tools:
  - Read
  - Write
  - Edit
...
| Skill | Quando Usar |
|-------|-------------|
| `writing-plans` | **Sempre** - planejar estrutura de docs |
| `verification-before-completion` | Antes de finalizar documentacao |

## Tools MCP

| Tool | Proposito |
|------|-----------|
| `mcp__context7__*` | Docs de Markdown, API specs, diagramas |
