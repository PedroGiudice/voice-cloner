...
| Skill | Quando Usar |
|-------|-------------|
| `brainstorming` | Explorar abordagens de refatoracao |
| `writing-plans` | Documentar plano de refatoracao |
| `systematic-debugging` | Quando refatoracao causa bugs |
| `verification-before-completion` | Antes de finalizar refatoracao |

## Tools MCP

| Tool | Proposito |
|------|-----------|
| `mcp__context7__*` | Docs de patterns, best practices |
